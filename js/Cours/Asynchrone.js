// ======================== Les requêtes asynchrones avec JavaScript ========================
...
// ======================== Async et Await avec JavaScript ========================

// Async et Await sont ce qu'on appelle des "sucres syntaxiques" : 
// ils n'apportent pas de nouvelles fonctionnalités, mais permettent d'utiliser les promesses de façon plus intuitives.
...
// Si elle est rompue, alors, il génèrera une exception. Nous ne somme ainsi plus obligés d'utiliser then() et catch().
