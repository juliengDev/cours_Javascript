...
//         console.log(this.pseudo + " attaque avec son coup special puissance des arcanes " + personnage.pseudo +
...
//     coupSpecial(personnage) {
//         personnage.sante -= this.attaque * 5;
//         console.log(this.pseudo + " attaque avec son coup special hache de guerre " + personnage.pseudo +
//         " (" + (attaque * 5) + ") degats)");
//         this.evoluer();
//         personnage.verifierSante();
//     }
